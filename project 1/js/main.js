...
(() =>{
    ...
    function fadeOutEffect(){
        ...
        setTimeout(() =>{
            document.querySelector(".fade-out-effect").classList.remove("active");},300)
    }
    ...
    document.addEventListener("click", (event) =>{
        ...
        /*make sure event.target.hash has a value before overridding default behaviour*/
            if(event.target.hash !==""){
                ...
                // deactive excisting active 'section'
                document.querySelector(".section.active").classList.add("hide");
                document.querySelector(".section.active").classList.remove("active");
                // activate new 'section'
                document.querySelector(hash).classList.add("active");
                document.querySelector(hash).classList.remove("hide");
                /* deactivate excisting active navigation menu 'link-item'*/
...
(() =>{
    ...
    filterContainer.addEventListener("click", (event)=>{
        ...
        !event.target.classList.contains("active")){
            // deactive excisting active ' filter item'
